...
public:
	...
	enum
	{
		kFlag_kNone = 0,
		kFlag_kHitScan = 1 << 0,
		kFlag_kExplosion = 1 << 1,
		kFlag_kExplosionAltTrigger = 1 << 2,
		kFlag_kMuzzleFlash = 1 << 3,
		kFlag_kCanTurnOff = 1 << 5,
		kFlag_kCanPickUp = 1 << 6,
		kFlag_kSupersonic = 1 << 7,
		kFlag_kPinsLimbs = 1 << 8,
		kFlag_kPassSMTransparent = 1 << 9,
		kFlag_kDisableCombatAimCorrection = 1 << 10,
		kFlag_kContinuousUpdate = 1 << 11
	};
...
public:
	...
	public:
		...
		SpellFlag								flags;		  // 04
		SpellType								spellType;	  // 08
		float									   chargeTime;	  // 0C
		CastingType								 castingType;	  // 10
	...
	UInt32	GetMagickaCost() { return data.costOverride; }
};
